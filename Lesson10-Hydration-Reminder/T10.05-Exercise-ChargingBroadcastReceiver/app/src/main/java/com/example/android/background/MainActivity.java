...
public class MainActivity extends AppCompatActivity implements
    ...
    private ChargingBroadcastReceiver mBroadcastReceiver;
    private IntentFilter mIntFilt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIntFilt = new IntentFilter(Intent.ACTION_POWER_CONNECTED);
        mIntFilt.addAction(Intent.ACTION_POWER_CONNECTED);
    }
    ...
    protected void onResume() {
        ...
        registerReceiver(mBroadcastReceiver, mIntFilt);
    }
